...
5. **마이페이지** — 자격증 검색·축약/전체보기, 외부활동, 선호 직군 1~3순위, 직군별 준비도, 자소서 파일 관리·추천 기업, 항목 선택형 자동 이력서 미리보기·DOC 다운로드
...
- 자동 이력서는 직무별 양식과 포함할 자격증·외부활동을 선택해 미리보기를 만들고, Word에서 열 수 있는 `.doc` 파일로 다운로드한다.
